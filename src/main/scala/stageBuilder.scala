...
class StageBuilder(tickers: Seq[(String, String)]) extends Layouts {
  ...
  // Buttons
  val updateButton                    = new Button{ text = "Refresh";                   onAction = (e) => { updateStage() } }
  ...
  val buttonAdd                       = new Button{ text = "ADD";                       onAction = (e) => {
  ...
  // Main method for rendering the Stock viewing stage
  ...
  // Method for changing between the two stages
  ...
  // Method for updating data and charts
